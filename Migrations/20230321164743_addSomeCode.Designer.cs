...
namespace RestaurantAPI.Migrations
{
    ...
    [Migration("20230321164743_addSomeCode")]
    partial class addSomeCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.BasketItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.Courier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.DailySales", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.OrderHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TrackingDeliveryId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TrackingDeliveryId");
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.TrackingDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TrackingDeliveries");
                });

            modelBuilder.Entity("RestaurantAPI.Entities.TrackingStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.Basket", b =>
                {
                    ...
                    b.HasOne("RestaurantAPI.Entities.Discount", "Discount")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.BasketItems", b =>
                {
                    b.HasOne("RestaurantAPI.Entities.Basket", "Basket")
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.OrderHistory", b =>
                {
                    b.HasOne("RestaurantAPI.Entities.TrackingDelivery", "TrackingDelivery")
                        .WithMany("OrderHistories")
                        .HasForeignKey("TrackingDeliveryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TrackingDelivery");
                });
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.TrackingDelivery", b =>
                {
                    b.HasOne("RestaurantAPI.Entities.Basket", "Basket")
                        .WithMany("TrackingDeliveries")
                        .HasForeignKey("BasketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RestaurantAPI.Entities.Courier", "Courier")
                        .WithMany("TrackingDeliveries")
                        .HasForeignKey("CourierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RestaurantAPI.Entities.TrackingStatus", "TrackingStatus")
                        .WithMany("TrackingDeliveries")
            ...
            modelBuilder.Entity("RestaurantAPI.Model.Reservation", b =>
                {
                    ...
                    b.HasOne("RestaurantAPI.Model.Table", null)
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("RestaurantAPI.Entities.Basket", b =>
                {
                    ...
                    b.Navigation("TrackingDeliveries");
                });
